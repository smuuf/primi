 ...
 */
function is_array_dict(array $input): bool {
 ...
 *
 */
function is_any_of_types(?Value $value, string ...$types): bool {
 ...
 */
function ensure_indexed(array $array): array {
...
function get_position_estimate(string $string, int $offset): array {
 ...
 */
function parse_argument_count_error(\ArgumentCountError $e): array {
 ...
 * expects.
 */
function get_primi_parameter_types_from_function(
...
function yield_left_to_right(array $node, Context $context) {
